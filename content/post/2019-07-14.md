...
I CAN CHANGE THIS PART(`*.md`) instead of R Markdown (`*.Rmd`). The major differences are: date: "2016-12-30T21:49:57-07:00"

1. YESSSSSSS, you can embed R code chunks (```` ```{r} ````);
2. A plain Markdown post is rendered through [**changing the link**](https://www.emilyzabor.com/tutorials/rmarkdown_websites_tutorial.html), and an R Markdown documentand [Pandoc](http://pandoc.org).
